...
class VendorReset extends StatefulWidget {
  final String email;

  const VendorReset({Key? key, required this.email}) : super(key: key);

  @override
  State<VendorReset> createState() => _ResetPasswordScreenState();
}

class _ResetPasswordScreenState extends State<VendorReset> {
  ...
  Future<void> handleResetPassword() async {
    ...
    try {
      ...
      final res = await http.post(
        Uri.parse('$backendUrl/api/vendor/auth/resetpassword'),
      ...
      if (res.statusCode == 200) {
        ...
        Future.delayed(const Duration(seconds: 2), () {
          Navigator.pushReplacementNamed(context, '/Login/VendorLogin');
        });
      } else {
